class QrcodesController < ApplicationController
  ...
  # TT
  before_action :set_wishlist, only: [:index, :show, :edit, :new, :create, :destroy]
  ...
  def show_product_name
    name = Product.find(@qrcode.product_id)
    name    
  end
  ...
  private
    ...
    def qrcode_params
      params.require(:qrcode).permit(:product_id, :qrcode_img)
    end
end
